...
export default function Home() {
   ...
   return (
      <Box component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box className={classNames(Style.avatar, Style.shadowed)} alt={'image of ' + info.firstName} style={{background: info.gradient}} component={'img'} src={me} width={{xs: '35vh', md: '40vh'}}
